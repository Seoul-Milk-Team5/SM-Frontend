  ...
  return (
    <div className="bg-gray-50 min-h-screen flex justify-center items-center px-8 mb:bg-[#fff]">
      <SidebarProvider className="flex w-full max-w-[1280px] gap-4">
        ...
        <main className="flex-1 max-w-[1064px] bg-[#FFF] px-6 pb-6 pt-7 rounded-[10px] shadow-md mt-[25px] mb-[25px] mb:shadow-none mb:px-0 mb:h-screen mb:relative main-scrollable">
          <Outlet />
        </main>
      </SidebarProvider>
    </div>
